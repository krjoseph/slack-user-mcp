    ...
    const httpServer = http.createServer(async (req, res) => {
        ...
        if (req.method === 'GET' && req.url === '/.well-known/openid-configuration') {
            ...
            res.end(JSON.stringify({
                ...
                "authorization_endpoint": "https://slack.com/oauth/v2/authorize?user_scope=channels:history,channels:read,users:read,chat:write,reactions:write,groups:read,users:read.email&",
